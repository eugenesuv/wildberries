...
- Если в контексте уже есть сегменты, вопросы должны помогать развести пользователей именно по этим сегментам. Но не спрашивать напрямую к какому сегменту относится пользователь.
