...
type UpdatePromotionRequest struct {
	...
	MaxDiscount        *int32                 `protobuf:"varint,15,opt,name=max_discount,json=maxDiscount,proto3,oneof" json:"max_discount,omitempty"`
...
const file_admin_proto_rawDesc = "" +
	...
	"\fmax_discount\x18\x10 \x01(\x05R\vmaxDiscount\x1a>\n" +
	...
	"\fmax_discount\x18\x0f \x01(\x05H\tR\vmaxDiscount\x88\x01\x01\x12!\n" +
	"\fstop_factors\x18\v \x03(\tR\vstopFactorsB\a\n" +
	"\x05_nameB\x0e\n" +
	"\f_descriptionB\b\n" +
	"\x06_themeB\f\n" +
	"\n" +
