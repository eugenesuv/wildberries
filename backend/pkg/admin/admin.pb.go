...
type CreatePromotionRequest struct {
	...
	Discount           int32                  `protobuf:"varint,9,opt,name=discount,proto3" json:"discount,omitempty"` // WB discount (admin setting) for WB-curated slots
...
func (x *GetPromotionsResponse) GetPromotions() []*SinglePromotion {
	if x != nil {
		return x.Promotions
	}
	return nil
...
type UpdatePromotionRequest struct {
	...
	MinPrice           *int64                 `protobuf:"varint,11,opt,name=minPrice,proto3,oneof" json:"minPrice,omitempty"`
	BidStep            *int64                 `protobuf:"varint,12,opt,name=bidStep,proto3,oneof" json:"bidStep,omitempty"`
...
func (x *UpdatePromotionRequest) GetMinPrice() int64 {
...
func (x *UpdatePromotionRequest) GetBidStep() int64 {
	if x != nil && x.BidStep != nil {
		return *x.BidStep
	}
	return 0
}
...
type GetAuctionParamsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            int64                  `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *GetAuctionParamsRequest) Reset() {
	*x = GetAuctionParamsRequest{}
	mi := &file_admin_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetAuctionParamsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetAuctionParamsRequest) ProtoMessage() {}

func (x *GetAuctionParamsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_admin_proto_msgTypes[15]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetAuctionParamsRequest.ProtoReflect.Descriptor instead.
func (*GetAuctionParamsRequest) Descriptor() ([]byte, []int) {
	return file_admin_proto_rawDescGZIP(), []int{15}
}

func (x *GetAuctionParamsRequest) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
type GetAuctionParamsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            int64                  `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`
	MinPrice      int64                  `protobuf:"varint,2,opt,name=minPrice,proto3" json:"minPrice,omitempty"`
	BidStep       int64                  `protobuf:"varint,3,opt,name=bidStep,proto3" json:"bidStep,omitempty"`
...
func (x *GetAuctionParamsResponse) Reset() {
	*x = GetAuctionParamsResponse{}
	mi := &file_admin_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetAuctionParamsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetAuctionParamsResponse) ProtoMessage() {}

func (x *GetAuctionParamsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_admin_proto_msgTypes[16]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetAuctionParamsResponse.ProtoReflect.Descriptor instead.
func (*GetAuctionParamsResponse) Descriptor() ([]byte, []int) {
	return file_admin_proto_rawDescGZIP(), []int{16}
}

func (x *GetAuctionParamsResponse) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *GetAuctionParamsResponse) GetMinPrice() int64 {
	if x != nil {
		return x.MinPrice
	}
	return 0
...
func (x *GetAuctionParamsResponse) GetBidStep() int64 {
	if x != nil {
		return x.BidStep
	}
	return 0
...
func (x *GetAuctionParamsResponse) GetDateFrom() string {
	if x != nil {
		return x.DateFrom
	}
	return ""
...
func (x *GetAuctionParamsResponse) GetDateTo() string {
	if x != nil {
		return x.DateTo
	}
	return ""
...
const file_admin_proto_rawDesc = "" +
	"\n" +
	"\vadmin.proto\x12\x11wildberries.admin\x1a\fcommon.proto\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"\xce\x02\n" +
	...
	"\n" +
	"slot_count\x18\b \x01(\x05R\tslotCount\x12\x1a\n" +
	...
	"\x14GetPromotionsRequest\"[\n" +
	"\x15GetPromotionsResponse\x12B\n" +
	"\n" +
	...
	"\x05value\x18\x04 \x01(\tR\x05value\"\xe7\x04\n" +
	...
	"\n" +
	"slot_count\x18\t \x01(\x05H\aR\tslotCount\x88\x01\x01\x12\x1f\n" +
	"\bdiscount\x18\n" +
	" \x01(\x05H\bR\bdiscount\x88\x01\x01\x12\x1f\n" +
	"\bminPrice\x18\v \x01(\x03H\tR\bminPrice\x88\x01\x01\x12\x1d\n" +
	"\abidStep\x18\f \x01(\x03H\n" +
	"R\abidStep\x88\x01\x01\x12!\n" +
	"\fstop_factors\x18\r \x03(\tR\vstopFactorsB\a\n" +
	"\x05_nameB\x0e\n" +
	"\f_descriptionB\b\n" +
	"\x06_themeB\f\n" +
	"\n" +
	...
	"\x17DeletePromotionResponse\"%\n" +
	"\x13GetPromotionRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\")\n" +
	"\x17GetAuctionParamsRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\"\x94\x01\n" +
	"\x18GetAuctionParamsResponse\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x1a\n" +
	"\bminPrice\x18\x02 \x01(\x03R\bminPrice\x12\x18\n" +
	"\abidStep\x18\x03 \x01(\x03R\abidStep\x12\x1a\n" +
	"\bDateFrom\x18\x04 \x01(\tR\bDateFrom\x12\x16\n" +
	"\x06DateTo\x18\x05 \x01(\tR\x06DateTo\"v\n" +
	...
	"\x18RejectModerationResponse2\x88\x14\n" +
	...
	"\n" +
	"Promotions\x12$Создать новую акцию\x1aQСоздает новую акцию с заданными параметрами*\x0fCreatePromotion\x82\xd3\xe4\x93\x02\x16:\x01*\"\x11/admin/promotions\x12\x8f\x02\n" +
	"\rGetPromotions\x12'.wildberries.admin.GetPromotionsRequest\x1a(.wildberries.admin.GetPromotionsResponse\"\xaa\x01\x92A\x8d\x01\n" +
	"\n" +
	"Promotions\x127Получить информацию об акциях\x1a7Получает информацию об акциях*\rGetPromotions\x82\xd3\xe4\x93\x02\x13\x12\x11/admin/promotions\x12\xfb\x01\n" +
	...
	"\n" +
	"Promotions\x12\x1bОбновить акцию\x1a0Обновляет параметры акции*\x0fUpdatePromotion\x82\xd3\xe4\x93\x02\x1b:\x01*2\x16/admin/promotions/{id}\x12\x8f\x02\n" +
	"\fGetPromotion\x12&.wildberries.admin.GetPromotionRequest\x1a\".wildberries.admin.SinglePromotion\"\xb2\x01\x92A\x90\x01\n" +
	"\n" +
	"Promotions\x125Получить информацию об акции\x1a=Получает информацию об акции по ID*\fGetPromotion\x82\xd3\xe4\x93\x02\x18\x12\x16/admin/promotions/{id}\x12\xe6\x01\n" +
	"\x0fDeletePromotion\x12).wildberries.admin.DeletePromotionRequest\x1a*.wildberries.admin.DeletePromotionResponse\"|\x92A[\n" +
	"\n" +
	"Promotions\x12\x19Удалить акцию\x1a!Удаляет акцию по ID*\x0fDeletePromotion\x82\xd3\xe4\x93\x02\x18*\x16/admin/promotions/{id}\x12\xc7\x02\n" +
	"\x10GetAuctionParams\x12*.wildberries.admin.GetAuctionParamsRequest\x1a+.wildberries.admin.GetAuctionParamsResponse\"\xd9\x01\x92A\xa8\x01\n" +
	"\n" +
	"Promotions\x12?Получить параметры аукциона акции\x1aGПолучает параметры аукциона акции по ID*\x10GetAuctionParams\x82\xd3\xe4\x93\x02'\x12%/admin/promotions/{id}/auction-params\x12\xd9\x02\n" +
...
var file_admin_proto_goTypes = []any{
	...
	(*GetPromotionsRequest)(nil),              // 2: wildberries.admin.GetPromotionsRequest
	(*GetPromotionsResponse)(nil),             // 3: wildberries.admin.GetPromotionsResponse
	...
	(*GetPromotionRequest)(nil),               // 14: wildberries.admin.GetPromotionRequest
	(*GetAuctionParamsRequest)(nil),           // 15: wildberries.admin.GetAuctionParamsRequest
	(*GetAuctionParamsResponse)(nil),          // 16: wildberries.admin.GetAuctionParamsResponse
	(*SetFixedPricesRequest)(nil),             // 17: wildberries.admin.SetFixedPricesRequest
	(*FixedPriceEntry)(nil),                   // 18: wildberries.admin.FixedPriceEntry
	(*SetFixedPricesResponse)(nil),            // 19: wildberries.admin.SetFixedPricesResponse
	(*ChangeStatusRequest)(nil),               // 20: wildberries.admin.ChangeStatusRequest
	(*ChangeStatusResponse)(nil),              // 21: wildberries.admin.ChangeStatusResponse
	(*SetSlotProductRequest)(nil),             // 22: wildberries.admin.SetSlotProductRequest
	(*SetSlotProductResponse)(nil),            // 23: wildberries.admin.SetSlotProductResponse
	(*GenerateSegmentsRequest)(nil),           // 24: wildberries.admin.GenerateSegmentsRequest
	(*GenerateSegmentsResponse)(nil),          // 25: wildberries.admin.GenerateSegmentsResponse
	(*CreateSegmentRequest)(nil),              // 26: wildberries.admin.CreateSegmentRequest
	(*CreateSegmentResponse)(nil),             // 27: wildberries.admin.CreateSegmentResponse
	(*UpdateSegmentRequest)(nil),              // 28: wildberries.admin.UpdateSegmentRequest
	(*UpdateSegmentResponse)(nil),             // 29: wildberries.admin.UpdateSegmentResponse
	(*DeleteSegmentRequest)(nil),              // 30: wildberries.admin.DeleteSegmentRequest
	(*DeleteSegmentResponse)(nil),             // 31: wildberries.admin.DeleteSegmentResponse
	(*ShuffleSegmentCategoriesRequest)(nil),   // 32: wildberries.admin.ShuffleSegmentCategoriesRequest
	(*ShuffleSegmentCategoriesResponse)(nil),  // 33: wildberries.admin.ShuffleSegmentCategoriesResponse
	(*GeneratePollRequest)(nil),               // 34: wildberries.admin.GeneratePollRequest
	(*GeneratePollResponse)(nil),              // 35: wildberries.admin.GeneratePollResponse
	(*SetPollQuestionsRequest)(nil),           // 36: wildberries.admin.SetPollQuestionsRequest
	(*SetQuestionInput)(nil),                  // 37: wildberries.admin.SetQuestionInput
	(*SetOptionInput)(nil),                    // 38: wildberries.admin.SetOptionInput
	(*SetPollQuestionsResponse)(nil),          // 39: wildberries.admin.SetPollQuestionsResponse
	(*SetAnswerTreeRequest)(nil),              // 40: wildberries.admin.SetAnswerTreeRequest
	(*SetAnswerTreeResponse)(nil),             // 41: wildberries.admin.SetAnswerTreeResponse
	(*GetModerationApplicationsRequest)(nil),  // 42: wildberries.admin.GetModerationApplicationsRequest
	(*ModerationApplication)(nil),             // 43: wildberries.admin.ModerationApplication
	(*GetModerationApplicationsResponse)(nil), // 44: wildberries.admin.GetModerationApplicationsResponse
	(*ApproveModerationRequest)(nil),          // 45: wildberries.admin.ApproveModerationRequest
	(*ApproveModerationResponse)(nil),         // 46: wildberries.admin.ApproveModerationResponse
	(*RejectModerationRequest)(nil),           // 47: wildberries.admin.RejectModerationRequest
	(*RejectModerationResponse)(nil),          // 48: wildberries.admin.RejectModerationResponse
	nil,                                       // 49: wildberries.admin.SinglePromotion.FixedPricesEntry
	(*common.Segment)(nil),                    // 50: wildberries.common.Segment
}
var file_admin_proto_depIdxs = []int32{
	4,  // 0: wildberries.admin.GetPromotionsResponse.promotions:type_name -> wildberries.admin.SinglePromotion
	5,  // 1: wildberries.admin.SinglePromotion.segments:type_name -> wildberries.admin.SegmentWithOrder
	49, // 2: wildberries.admin.SinglePromotion.fixed_prices:type_name -> wildberries.admin.SinglePromotion.FixedPricesEntry
	...
	18, // 7: wildberries.admin.SetFixedPricesRequest.prices:type_name -> wildberries.admin.FixedPriceEntry
	50, // 8: wildberries.admin.GenerateSegmentsResponse.segments:type_name -> wildberries.common.Segment
	...
	37, // 11: wildberries.admin.SetPollQuestionsRequest.questions:type_name -> wildberries.admin.SetQuestionInput
	38, // 12: wildberries.admin.SetQuestionInput.options:type_name -> wildberries.admin.SetOptionInput
	9,  // 13: wildberries.admin.SetAnswerTreeRequest.nodes:type_name -> wildberries.admin.AnswerTreeNode
	43, // 14: wildberries.admin.GetModerationApplicationsResponse.applications:type_name -> wildberries.admin.ModerationApplication
	0,  // 15: wildberries.admin.PromotionAdminService.CreatePromotion:input_type -> wildberries.admin.CreatePromotionRequest
	2,  // 16: wildberries.admin.PromotionAdminService.GetPromotions:input_type -> wildberries.admin.GetPromotionsRequest
	10, // 17: wildberries.admin.PromotionAdminService.UpdatePromotion:input_type -> wildberries.admin.UpdatePromotionRequest
	14, // 18: wildberries.admin.PromotionAdminService.GetPromotion:input_type -> wildberries.admin.GetPromotionRequest
	12, // 19: wildberries.admin.PromotionAdminService.DeletePromotion:input_type -> wildberries.admin.DeletePromotionRequest
	15, // 20: wildberries.admin.PromotionAdminService.GetAuctionParams:input_type -> wildberries.admin.GetAuctionParamsRequest
	17, // 21: wildberries.admin.PromotionAdminService.SetFixedPrices:input_type -> wildberries.admin.SetFixedPricesRequest
	20, // 22: wildberries.admin.PromotionAdminService.ChangeStatus:input_type -> wildberries.admin.ChangeStatusRequest
	22, // 23: wildberries.admin.PromotionAdminService.SetSlotProduct:input_type -> wildberries.admin.SetSlotProductRequest
	24, // 24: wildberries.admin.SegmentAdminService.GenerateSegments:input_type -> wildberries.admin.GenerateSegmentsRequest
	26, // 25: wildberries.admin.SegmentAdminService.CreateSegment:input_type -> wildberries.admin.CreateSegmentRequest
	28, // 26: wildberries.admin.SegmentAdminService.UpdateSegment:input_type -> wildberries.admin.UpdateSegmentRequest
	30, // 27: wildberries.admin.SegmentAdminService.DeleteSegment:input_type -> wildberries.admin.DeleteSegmentRequest
	32, // 28: wildberries.admin.SegmentAdminService.ShuffleSegmentCategories:input_type -> wildberries.admin.ShuffleSegmentCategoriesRequest
	34, // 29: wildberries.admin.PollAdminService.GeneratePoll:input_type -> wildberries.admin.GeneratePollRequest
	36, // 30: wildberries.admin.PollAdminService.SetPollQuestions:input_type -> wildberries.admin.SetPollQuestionsRequest
	40, // 31: wildberries.admin.PollAdminService.SetAnswerTree:input_type -> wildberries.admin.SetAnswerTreeRequest
	42, // 32: wildberries.admin.ModerationService.GetApplications:input_type -> wildberries.admin.GetModerationApplicationsRequest
	45, // 33: wildberries.admin.ModerationService.Approve:input_type -> wildberries.admin.ApproveModerationRequest
	47, // 34: wildberries.admin.ModerationService.Reject:input_type -> wildberries.admin.RejectModerationRequest
	1,  // 35: wildberries.admin.PromotionAdminService.CreatePromotion:output_type -> wildberries.admin.CreatePromotionResponse
	3,  // 36: wildberries.admin.PromotionAdminService.GetPromotions:output_type -> wildberries.admin.GetPromotionsResponse
	11, // 37: wildberries.admin.PromotionAdminService.UpdatePromotion:output_type -> wildberries.admin.UpdatePromotionResponse
	4,  // 38: wildberries.admin.PromotionAdminService.GetPromotion:output_type -> wildberries.admin.SinglePromotion
	13, // 39: wildberries.admin.PromotionAdminService.DeletePromotion:output_type -> wildberries.admin.DeletePromotionResponse
	16, // 40: wildberries.admin.PromotionAdminService.GetAuctionParams:output_type -> wildberries.admin.GetAuctionParamsResponse
	19, // 41: wildberries.admin.PromotionAdminService.SetFixedPrices:output_type -> wildberries.admin.SetFixedPricesResponse
	21, // 42: wildberries.admin.PromotionAdminService.ChangeStatus:output_type -> wildberries.admin.ChangeStatusResponse
	23, // 43: wildberries.admin.PromotionAdminService.SetSlotProduct:output_type -> wildberries.admin.SetSlotProductResponse
	25, // 44: wildberries.admin.SegmentAdminService.GenerateSegments:output_type -> wildberries.admin.GenerateSegmentsResponse
	27, // 45: wildberries.admin.SegmentAdminService.CreateSegment:output_type -> wildberries.admin.CreateSegmentResponse
	29, // 46: wildberries.admin.SegmentAdminService.UpdateSegment:output_type -> wildberries.admin.UpdateSegmentResponse
	31, // 47: wildberries.admin.SegmentAdminService.DeleteSegment:output_type -> wildberries.admin.DeleteSegmentResponse
	33, // 48: wildberries.admin.SegmentAdminService.ShuffleSegmentCategories:output_type -> wildberries.admin.ShuffleSegmentCategoriesResponse
	35, // 49: wildberries.admin.PollAdminService.GeneratePoll:output_type -> wildberries.admin.GeneratePollResponse
	39, // 50: wildberries.admin.PollAdminService.SetPollQuestions:output_type -> wildberries.admin.SetPollQuestionsResponse
	41, // 51: wildberries.admin.PollAdminService.SetAnswerTree:output_type -> wildberries.admin.SetAnswerTreeResponse
	44, // 52: wildberries.admin.ModerationService.GetApplications:output_type -> wildberries.admin.GetModerationApplicationsResponse
	46, // 53: wildberries.admin.ModerationService.Approve:output_type -> wildberries.admin.ApproveModerationResponse
	48, // 54: wildberries.admin.ModerationService.Reject:output_type -> wildberries.admin.RejectModerationResponse
