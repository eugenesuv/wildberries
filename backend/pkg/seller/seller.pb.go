...
const file_seller_proto_rawDesc = "" +
	...
	"\x05items\x18\x01 \x03(\v2!.wildberries.seller.SellerBetItemR\x05items\"}\n" +
	...
	"\n" +
	"product_id\x18\x04 \x01(\x03R\tproductId\"E\n" +
	...
	"\x13Seller сервис\x12AСервис селлера для работы с акциями2\x051.0.0\x1a\x0elocalhost:8080*\x01\x012\x10application/json:\x10application/jsonZ%wildberries/backend/pkg/seller;sellerb\x06proto3"
