...
const (
	IdentificationMode_MODE_UNKNOWN      IdentificationMode = 0
	IdentificationMode_MODE_QUESTIONS    IdentificationMode = 1
	IdentificationMode_MODE_USER_PROFILE IdentificationMode = 2
)
...
const (
	PricingModel_MODEL_UNKNOWN PricingModel = 0
	PricingModel_MODEL_AUCTION PricingModel = 1
	PricingModel_MODEL_FIXED   PricingModel = 2
)
...
type CreatePromotionRequest struct {
	...
	IdentificationMode IdentificationMode     `protobuf:"varint,6,opt,name=identification_mode,json=identificationMode,proto3,enum=wildberries.admin.IdentificationMode" json:"identification_mode,omitempty"` // questions | user_profile
	PricingModel       PricingModel           `protobuf:"varint,7,opt,name=pricing_model,json=pricingModel,proto3,enum=wildberries.admin.PricingModel" json:"pricing_model,omitempty"`                         // auction | fixed
	SlotCount          int64                  `protobuf:"varint,8,opt,name=slot_count,json=slotCount,proto3" json:"slot_count,omitempty"`
	MinDiscount        int64                  `protobuf:"varint,9,opt,name=min_discount,json=minDiscount,proto3" json:"min_discount,omitempty"`
	MaxDiscount        int64                  `protobuf:"varint,10,opt,name=max_discount,json=maxDiscount,proto3" json:"max_discount,omitempty"`
...
func (x *CreatePromotionRequest) GetIdentificationMode() IdentificationMode {
	if x != nil {
		return x.IdentificationMode
	}
	return IdentificationMode_MODE_UNKNOWN
}

func (x *CreatePromotionRequest) GetPricingModel() PricingModel {
	if x != nil {
		return x.PricingModel
	}
	return PricingModel_MODEL_UNKNOWN
}

func (x *CreatePromotionRequest) GetSlotCount() int64 {
	if x != nil {
		return x.SlotCount
	}
	return 0
...
func (x *CreatePromotionRequest) GetMinDiscount() int64 {
	if x != nil {
...
func (x *CreatePromotionRequest) GetMaxDiscount() int64 {
	if x != nil {
...
type GetPromotionResponse struct {
	...
	IdentificationMode IdentificationMode     `protobuf:"varint,8,opt,name=identification_mode,json=identificationMode,proto3,enum=wildberries.admin.IdentificationMode" json:"identification_mode,omitempty"`
	PricingModel       PricingModel           `protobuf:"varint,9,opt,name=pricing_model,json=pricingModel,proto3,enum=wildberries.admin.PricingModel" json:"pricing_model,omitempty"`
...
func (x *GetPromotionResponse) GetIdentificationMode() IdentificationMode {
	if x != nil {
		return x.IdentificationMode
	}
	return IdentificationMode_MODE_UNKNOWN
...
func (x *GetPromotionResponse) GetPricingModel() PricingModel {
	if x != nil {
		return x.PricingModel
	}
	return PricingModel_MODEL_UNKNOWN
...
type UpdatePromotionRequest struct {
	...
	IdentificationMode *IdentificationMode    `protobuf:"varint,7,opt,name=identification_mode,json=identificationMode,proto3,enum=wildberries.admin.IdentificationMode,oneof" json:"identification_mode,omitempty"`
	PricingModel       *PricingModel          `protobuf:"varint,8,opt,name=pricing_model,json=pricingModel,proto3,enum=wildberries.admin.PricingModel,oneof" json:"pricing_model,omitempty"`
...
func (x *UpdatePromotionRequest) GetIdentificationMode() IdentificationMode {
...
func (x *UpdatePromotionRequest) GetPricingModel() PricingModel {
...
const file_admin_proto_rawDesc = "" +
	"\n" +
	"\vadmin.proto\x12\x11wildberries.admin\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\fcommon.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x17validate/validate.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"\xc0\x03\n" +
	...
	"\adate_to\x18\x05 \x01(\tR\x06dateTo\x12V\n" +
	"\x13identification_mode\x18\x06 \x01(\x0e2%.wildberries.admin.IdentificationModeR\x12identificationMode\x12D\n" +
	"\rpricing_model\x18\a \x01(\x0e2\x1f.wildberries.admin.PricingModelR\fpricingModel\x12\x1d\n" +
	"\n" +
	"slot_count\x18\b \x01(\x03R\tslotCount\x12!\n" +
	"\fmin_discount\x18\t \x01(\x03R\vminDiscount\x12!\n" +
	"\fmax_discount\x18\n" +
	" \x01(\x03R\vmaxDiscount\x12!\n" +
	"\fstop_factors\x18\v \x03(\tR\vstopFactors\"A\n" +
	"\x17CreatePromotionResponse\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x16\n" +
	"\x06status\x18\x02 \x01(\tR\x06status\"%\n" +
	"\x13GetPromotionRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\"\xfa\x05\n" +
	...
	"\adate_to\x18\a \x01(\tR\x06dateTo\x12V\n" +
	"\x13identification_mode\x18\b \x01(\x0e2%.wildberries.admin.IdentificationModeR\x12identificationMode\x12D\n" +
	"\rpricing_model\x18\t \x01(\x0e2\x1f.wildberries.admin.PricingModelR\fpricingModel\x12\x1d\n" +
	"\n" +
	"slot_count\x18\n" +
	...
	"\x05value\x18\x04 \x01(\tR\x05value\"\x9a\x05\n" +
	...
	"\adate_to\x18\x06 \x01(\tH\x04R\x06dateTo\x88\x01\x01\x12[\n" +
	"\x13identification_mode\x18\a \x01(\x0e2%.wildberries.admin.IdentificationModeH\x05R\x12identificationMode\x88\x01\x01\x12I\n" +
	"\rpricing_model\x18\b \x01(\x0e2\x1f.wildberries.admin.PricingModelH\x06R\fpricingModel\x88\x01\x01\x12\"\n" +
	"\n" +
	...
	"\x18RejectModerationResponse*Q\n" +
	"\x12IdentificationMode\x12\x10\n" +
	"\fMODE_UNKNOWN\x10\x00\x12\x12\n" +
	"\x0eMODE_QUESTIONS\x10\x01\x12\x15\n" +
	"\x11MODE_USER_PROFILE\x10\x02*E\n" +
	"\fPricingModel\x12\x11\n" +
	"\rMODEL_UNKNOWN\x10\x00\x12\x11\n" +
	"\rMODEL_AUCTION\x10\x01\x12\x0f\n" +
	"\vMODEL_FIXED\x10\x022\xb1\x0f\n" +
...
var file_admin_proto_goTypes = []any{
	(IdentificationMode)(0),                   // 0: wildberries.admin.IdentificationMode
	(PricingModel)(0),                         // 1: wildberries.admin.PricingModel
	(*CreatePromotionRequest)(nil),            // 2: wildberries.admin.CreatePromotionRequest
	(*CreatePromotionResponse)(nil),           // 3: wildberries.admin.CreatePromotionResponse
	(*GetPromotionRequest)(nil),               // 4: wildberries.admin.GetPromotionRequest
	(*GetPromotionResponse)(nil),              // 5: wildberries.admin.GetPromotionResponse
	(*SegmentWithOrder)(nil),                  // 6: wildberries.admin.SegmentWithOrder
	(*PromotionPoll)(nil),                     // 7: wildberries.admin.PromotionPoll
	(*PollQuestionAdmin)(nil),                 // 8: wildberries.admin.PollQuestionAdmin
	(*PollOptionAdmin)(nil),                   // 9: wildberries.admin.PollOptionAdmin
	(*AnswerTreeNode)(nil),                    // 10: wildberries.admin.AnswerTreeNode
	(*UpdatePromotionRequest)(nil),            // 11: wildberries.admin.UpdatePromotionRequest
	(*UpdatePromotionResponse)(nil),           // 12: wildberries.admin.UpdatePromotionResponse
	(*DeletePromotionRequest)(nil),            // 13: wildberries.admin.DeletePromotionRequest
	(*DeletePromotionResponse)(nil),           // 14: wildberries.admin.DeletePromotionResponse
	(*SetFixedPricesRequest)(nil),             // 15: wildberries.admin.SetFixedPricesRequest
	(*FixedPriceEntry)(nil),                   // 16: wildberries.admin.FixedPriceEntry
	(*SetFixedPricesResponse)(nil),            // 17: wildberries.admin.SetFixedPricesResponse
	(*ChangeStatusRequest)(nil),               // 18: wildberries.admin.ChangeStatusRequest
	(*ChangeStatusResponse)(nil),              // 19: wildberries.admin.ChangeStatusResponse
	(*SetSlotProductRequest)(nil),             // 20: wildberries.admin.SetSlotProductRequest
	(*SetSlotProductResponse)(nil),            // 21: wildberries.admin.SetSlotProductResponse
	(*GenerateSegmentsRequest)(nil),           // 22: wildberries.admin.GenerateSegmentsRequest
	(*GenerateSegmentsResponse)(nil),          // 23: wildberries.admin.GenerateSegmentsResponse
	(*CreateSegmentRequest)(nil),              // 24: wildberries.admin.CreateSegmentRequest
	(*CreateSegmentResponse)(nil),             // 25: wildberries.admin.CreateSegmentResponse
	(*UpdateSegmentRequest)(nil),              // 26: wildberries.admin.UpdateSegmentRequest
	(*UpdateSegmentResponse)(nil),             // 27: wildberries.admin.UpdateSegmentResponse
	(*DeleteSegmentRequest)(nil),              // 28: wildberries.admin.DeleteSegmentRequest
	(*DeleteSegmentResponse)(nil),             // 29: wildberries.admin.DeleteSegmentResponse
	(*ShuffleSegmentCategoriesRequest)(nil),   // 30: wildberries.admin.ShuffleSegmentCategoriesRequest
	(*ShuffleSegmentCategoriesResponse)(nil),  // 31: wildberries.admin.ShuffleSegmentCategoriesResponse
	(*GeneratePollRequest)(nil),               // 32: wildberries.admin.GeneratePollRequest
	(*GeneratePollResponse)(nil),              // 33: wildberries.admin.GeneratePollResponse
	(*SetPollQuestionsRequest)(nil),           // 34: wildberries.admin.SetPollQuestionsRequest
	(*SetQuestionInput)(nil),                  // 35: wildberries.admin.SetQuestionInput
	(*SetOptionInput)(nil),                    // 36: wildberries.admin.SetOptionInput
	(*SetPollQuestionsResponse)(nil),          // 37: wildberries.admin.SetPollQuestionsResponse
	(*SetAnswerTreeRequest)(nil),              // 38: wildberries.admin.SetAnswerTreeRequest
	(*SetAnswerTreeResponse)(nil),             // 39: wildberries.admin.SetAnswerTreeResponse
	(*GetModerationApplicationsRequest)(nil),  // 40: wildberries.admin.GetModerationApplicationsRequest
	(*ModerationApplication)(nil),             // 41: wildberries.admin.ModerationApplication
	(*GetModerationApplicationsResponse)(nil), // 42: wildberries.admin.GetModerationApplicationsResponse
	(*ApproveModerationRequest)(nil),          // 43: wildberries.admin.ApproveModerationRequest
	(*ApproveModerationResponse)(nil),         // 44: wildberries.admin.ApproveModerationResponse
	(*RejectModerationRequest)(nil),           // 45: wildberries.admin.RejectModerationRequest
	(*RejectModerationResponse)(nil),          // 46: wildberries.admin.RejectModerationResponse
	nil,                                       // 47: wildberries.admin.GetPromotionResponse.FixedPricesEntry
	(*common.Segment)(nil),                    // 48: wildberries.common.Segment
}
var file_admin_proto_depIdxs = []int32{
	0,  // 0: wildberries.admin.CreatePromotionRequest.identification_mode:type_name -> wildberries.admin.IdentificationMode
	1,  // 1: wildberries.admin.CreatePromotionRequest.pricing_model:type_name -> wildberries.admin.PricingModel
	0,  // 2: wildberries.admin.GetPromotionResponse.identification_mode:type_name -> wildberries.admin.IdentificationMode
	1,  // 3: wildberries.admin.GetPromotionResponse.pricing_model:type_name -> wildberries.admin.PricingModel
	6,  // 4: wildberries.admin.GetPromotionResponse.segments:type_name -> wildberries.admin.SegmentWithOrder
	47, // 5: wildberries.admin.GetPromotionResponse.fixed_prices:type_name -> wildberries.admin.GetPromotionResponse.FixedPricesEntry
	7,  // 6: wildberries.admin.GetPromotionResponse.poll:type_name -> wildberries.admin.PromotionPoll
	8,  // 7: wildberries.admin.PromotionPoll.questions:type_name -> wildberries.admin.PollQuestionAdmin
	10, // 8: wildberries.admin.PromotionPoll.answer_tree:type_name -> wildberries.admin.AnswerTreeNode
	9,  // 9: wildberries.admin.PollQuestionAdmin.options:type_name -> wildberries.admin.PollOptionAdmin
	0,  // 10: wildberries.admin.UpdatePromotionRequest.identification_mode:type_name -> wildberries.admin.IdentificationMode
	1,  // 11: wildberries.admin.UpdatePromotionRequest.pricing_model:type_name -> wildberries.admin.PricingModel
	16, // 12: wildberries.admin.SetFixedPricesRequest.prices:type_name -> wildberries.admin.FixedPriceEntry
	48, // 13: wildberries.admin.GenerateSegmentsResponse.segments:type_name -> wildberries.common.Segment
	8,  // 14: wildberries.admin.GeneratePollResponse.questions:type_name -> wildberries.admin.PollQuestionAdmin
	10, // 15: wildberries.admin.GeneratePollResponse.answer_tree:type_name -> wildberries.admin.AnswerTreeNode
	35, // 16: wildberries.admin.SetPollQuestionsRequest.questions:type_name -> wildberries.admin.SetQuestionInput
	36, // 17: wildberries.admin.SetQuestionInput.options:type_name -> wildberries.admin.SetOptionInput
	10, // 18: wildberries.admin.SetAnswerTreeRequest.nodes:type_name -> wildberries.admin.AnswerTreeNode
	41, // 19: wildberries.admin.GetModerationApplicationsResponse.applications:type_name -> wildberries.admin.ModerationApplication
	2,  // 20: wildberries.admin.PromotionAdminService.CreatePromotion:input_type -> wildberries.admin.CreatePromotionRequest
	4,  // 21: wildberries.admin.PromotionAdminService.GetPromotion:input_type -> wildberries.admin.GetPromotionRequest
	11, // 22: wildberries.admin.PromotionAdminService.UpdatePromotion:input_type -> wildberries.admin.UpdatePromotionRequest
	13, // 23: wildberries.admin.PromotionAdminService.DeletePromotion:input_type -> wildberries.admin.DeletePromotionRequest
	15, // 24: wildberries.admin.PromotionAdminService.SetFixedPrices:input_type -> wildberries.admin.SetFixedPricesRequest
	18, // 25: wildberries.admin.PromotionAdminService.ChangeStatus:input_type -> wildberries.admin.ChangeStatusRequest
	20, // 26: wildberries.admin.PromotionAdminService.SetSlotProduct:input_type -> wildberries.admin.SetSlotProductRequest
	22, // 27: wildberries.admin.SegmentAdminService.GenerateSegments:input_type -> wildberries.admin.GenerateSegmentsRequest
	24, // 28: wildberries.admin.SegmentAdminService.CreateSegment:input_type -> wildberries.admin.CreateSegmentRequest
	26, // 29: wildberries.admin.SegmentAdminService.UpdateSegment:input_type -> wildberries.admin.UpdateSegmentRequest
	28, // 30: wildberries.admin.SegmentAdminService.DeleteSegment:input_type -> wildberries.admin.DeleteSegmentRequest
	30, // 31: wildberries.admin.SegmentAdminService.ShuffleSegmentCategories:input_type -> wildberries.admin.ShuffleSegmentCategoriesRequest
	32, // 32: wildberries.admin.PollAdminService.GeneratePoll:input_type -> wildberries.admin.GeneratePollRequest
	34, // 33: wildberries.admin.PollAdminService.SetPollQuestions:input_type -> wildberries.admin.SetPollQuestionsRequest
	38, // 34: wildberries.admin.PollAdminService.SetAnswerTree:input_type -> wildberries.admin.SetAnswerTreeRequest
	40, // 35: wildberries.admin.ModerationService.GetApplications:input_type -> wildberries.admin.GetModerationApplicationsRequest
	43, // 36: wildberries.admin.ModerationService.Approve:input_type -> wildberries.admin.ApproveModerationRequest
	45, // 37: wildberries.admin.ModerationService.Reject:input_type -> wildberries.admin.RejectModerationRequest
	3,  // 38: wildberries.admin.PromotionAdminService.CreatePromotion:output_type -> wildberries.admin.CreatePromotionResponse
	5,  // 39: wildberries.admin.PromotionAdminService.GetPromotion:output_type -> wildberries.admin.GetPromotionResponse
	12, // 40: wildberries.admin.PromotionAdminService.UpdatePromotion:output_type -> wildberries.admin.UpdatePromotionResponse
	14, // 41: wildberries.admin.PromotionAdminService.DeletePromotion:output_type -> wildberries.admin.DeletePromotionResponse
	17, // 42: wildberries.admin.PromotionAdminService.SetFixedPrices:output_type -> wildberries.admin.SetFixedPricesResponse
	19, // 43: wildberries.admin.PromotionAdminService.ChangeStatus:output_type -> wildberries.admin.ChangeStatusResponse
	21, // 44: wildberries.admin.PromotionAdminService.SetSlotProduct:output_type -> wildberries.admin.SetSlotProductResponse
	23, // 45: wildberries.admin.SegmentAdminService.GenerateSegments:output_type -> wildberries.admin.GenerateSegmentsResponse
	25, // 46: wildberries.admin.SegmentAdminService.CreateSegment:output_type -> wildberries.admin.CreateSegmentResponse
	27, // 47: wildberries.admin.SegmentAdminService.UpdateSegment:output_type -> wildberries.admin.UpdateSegmentResponse
	29, // 48: wildberries.admin.SegmentAdminService.DeleteSegment:output_type -> wildberries.admin.DeleteSegmentResponse
	31, // 49: wildberries.admin.SegmentAdminService.ShuffleSegmentCategories:output_type -> wildberries.admin.ShuffleSegmentCategoriesResponse
	33, // 50: wildberries.admin.PollAdminService.GeneratePoll:output_type -> wildberries.admin.GeneratePollResponse
	37, // 51: wildberries.admin.PollAdminService.SetPollQuestions:output_type -> wildberries.admin.SetPollQuestionsResponse
	39, // 52: wildberries.admin.PollAdminService.SetAnswerTree:output_type -> wildberries.admin.SetAnswerTreeResponse
	42, // 53: wildberries.admin.ModerationService.GetApplications:output_type -> wildberries.admin.GetModerationApplicationsResponse
	44, // 54: wildberries.admin.ModerationService.Approve:output_type -> wildberries.admin.ApproveModerationResponse
	46, // 55: wildberries.admin.ModerationService.Reject:output_type -> wildberries.admin.RejectModerationResponse
